...
// A ChunkList is a list of chunks stored in the CAS. The Digest of a ChunkList
// is computed over its protobuf wire format serialization.
type ChunkList struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// An ordered list of chunk digests.
...
func (x *ChunkList) GetChunkDigests() []*Digest {
	if x != nil {
...
type SplitBlobResponse struct {
	...
	// the order of the digests given by this list. If the indirect_chunk_list is
	// set this is instead a prefix of the indirect_chunk_list and the original
	// blob is assembled by concatenating the chunk data expressed by the
	// indirect_chunk_list.
	//
	...
	// [ContentAddressableStorage][build.bazel.remote.execution.v2.ContentAddressableStorage].
	// The server MAY set this field in addition to the chunk_digests field. If
	// set the chunk_digests field MUST be a prefix of the indirect_chunk_list and
	// the indirect_chunk_list represents the full list of chunks for the blob.
	IndirectChunkList *Digest `protobuf:"bytes,6,opt,name=indirect_chunk_list,json=indirectChunkList,proto3" json:"indirect_chunk_list,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SplitBlobResponse) GetIndirectChunkList() *Digest {
	if x != nil {
		return x.IndirectChunkList
	}
	return nil
}
...
type SpliceBlobRequest struct {
	...
	// assemble the original blob. If the indirect_chunk_list is set this is
	// instead a prefix of the indirect_chunk_list and the original blob is
	// assembled by concatenating the chunk data expressed by the
	// indirect_chunk_list.
	...
	// this field in addition to the chunk_digests field. If set the chunk_digests
	// field MUST be a prefix of the indirect_chunk_list and the
	// indirect_chunk_list represents the full list of chunks for the blob.
	IndirectChunkList *Digest `protobuf:"bytes,6,opt,name=indirect_chunk_list,json=indirectChunkList,proto3" json:"indirect_chunk_list,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SpliceBlobRequest) GetIndirectChunkList() *Digest {
	if x != nil {
		return x.IndirectChunkList
	}
	return nil
...
var file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_build_bazel_remote_execution_v2_remote_execution_proto_goTypes = []any{
	...
	(*ChunkList)(nil),                          // 40: build.bazel.remote.execution.v2.ChunkList
	(*SplitBlobRequest)(nil),                   // 41: build.bazel.remote.execution.v2.SplitBlobRequest
	(*SplitBlobResponse)(nil),                  // 42: build.bazel.remote.execution.v2.SplitBlobResponse
	(*SpliceBlobRequest)(nil),                  // 43: build.bazel.remote.execution.v2.SpliceBlobRequest
	(*SpliceBlobResponse)(nil),                 // 44: build.bazel.remote.execution.v2.SpliceBlobResponse
	(*GetCapabilitiesRequest)(nil),             // 45: build.bazel.remote.execution.v2.GetCapabilitiesRequest
	(*ServerCapabilities)(nil),                 // 46: build.bazel.remote.execution.v2.ServerCapabilities
	(*DigestFunction)(nil),                     // 47: build.bazel.remote.execution.v2.DigestFunction
	(*ChunkingFunction)(nil),                   // 48: build.bazel.remote.execution.v2.ChunkingFunction
	...
	(*FastCdc2020Params)(nil),                  // 54: build.bazel.remote.execution.v2.FastCdc2020Params
	(*RepMaxCdcParams)(nil),                    // 55: build.bazel.remote.execution.v2.RepMaxCdcParams
	(*ExecutionCapabilities)(nil),              // 56: build.bazel.remote.execution.v2.ExecutionCapabilities
	(*ToolDetails)(nil),                        // 57: build.bazel.remote.execution.v2.ToolDetails
	(*RequestMetadata)(nil),                    // 58: build.bazel.remote.execution.v2.RequestMetadata
	(*Command_EnvironmentVariable)(nil),        // 59: build.bazel.remote.execution.v2.Command.EnvironmentVariable
	(*Platform_Property)(nil),                  // 60: build.bazel.remote.execution.v2.Platform.Property
	nil,                                        // 61: build.bazel.remote.execution.v2.ExecuteResponse.ServerLogsEntry
	(*BatchUpdateBlobsRequest_Request)(nil),    // 62: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.Request
	(*BatchUpdateBlobsResponse_Response)(nil),  // 63: build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.Response
	(*BatchReadBlobsResponse_Response)(nil),    // 64: build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response
	(*PriorityCapabilities_PriorityRange)(nil), // 65: build.bazel.remote.execution.v2.PriorityCapabilities.PriorityRange
	...
	(*semver.SemVer)(nil),                      // 71: build.bazel.semver.SemVer
...
var file_build_bazel_remote_execution_v2_remote_execution_proto_depIdxs = []int32{
	...
	66,  // 2: build.bazel.remote.execution.v2.Action.timeout:type_name -> google.protobuf.Duration
	8,   // 3: build.bazel.remote.execution.v2.Action.platform:type_name -> build.bazel.remote.execution.v2.Platform
	59,  // 4: build.bazel.remote.execution.v2.Command.environment_variables:type_name -> build.bazel.remote.execution.v2.Command.EnvironmentVariable
	...
	60,  // 7: build.bazel.remote.execution.v2.Platform.properties:type_name -> build.bazel.remote.execution.v2.Platform.Property
	...
	67,  // 13: build.bazel.remote.execution.v2.NodeProperties.mtime:type_name -> google.protobuf.Timestamp
	68,  // 14: build.bazel.remote.execution.v2.NodeProperties.unix_mode:type_name -> google.protobuf.UInt32Value
	...
	67,  // 19: build.bazel.remote.execution.v2.ExecutedActionMetadata.queued_timestamp:type_name -> google.protobuf.Timestamp
	67,  // 20: build.bazel.remote.execution.v2.ExecutedActionMetadata.worker_start_timestamp:type_name -> google.protobuf.Timestamp
	67,  // 21: build.bazel.remote.execution.v2.ExecutedActionMetadata.worker_completed_timestamp:type_name -> google.protobuf.Timestamp
	67,  // 22: build.bazel.remote.execution.v2.ExecutedActionMetadata.input_fetch_start_timestamp:type_name -> google.protobuf.Timestamp
	67,  // 23: build.bazel.remote.execution.v2.ExecutedActionMetadata.input_fetch_completed_timestamp:type_name -> google.protobuf.Timestamp
	67,  // 24: build.bazel.remote.execution.v2.ExecutedActionMetadata.execution_start_timestamp:type_name -> google.protobuf.Timestamp
	67,  // 25: build.bazel.remote.execution.v2.ExecutedActionMetadata.execution_completed_timestamp:type_name -> google.protobuf.Timestamp
	66,  // 26: build.bazel.remote.execution.v2.ExecutedActionMetadata.virtual_execution_duration:type_name -> google.protobuf.Duration
	67,  // 27: build.bazel.remote.execution.v2.ExecutedActionMetadata.output_upload_start_timestamp:type_name -> google.protobuf.Timestamp
	67,  // 28: build.bazel.remote.execution.v2.ExecutedActionMetadata.output_upload_completed_timestamp:type_name -> google.protobuf.Timestamp
	69,  // 29: build.bazel.remote.execution.v2.ExecutedActionMetadata.auxiliary_metadata:type_name -> google.protobuf.Any
	...
	70,  // 51: build.bazel.remote.execution.v2.ExecuteResponse.status:type_name -> google.rpc.Status
	61,  // 52: build.bazel.remote.execution.v2.ExecuteResponse.server_logs:type_name -> build.bazel.remote.execution.v2.ExecuteResponse.ServerLogsEntry
	...
	62,  // 66: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.requests:type_name -> build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.Request
	...
	63,  // 68: build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.responses:type_name -> build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.Response
	...
	64,  // 72: build.bazel.remote.execution.v2.BatchReadBlobsResponse.responses:type_name -> build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response
	...
	15,  // 76: build.bazel.remote.execution.v2.ChunkList.chunk_digests:type_name -> build.bazel.remote.execution.v2.Digest
	15,  // 77: build.bazel.remote.execution.v2.SplitBlobRequest.blob_digest:type_name -> build.bazel.remote.execution.v2.Digest
	2,   // 78: build.bazel.remote.execution.v2.SplitBlobRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	3,   // 79: build.bazel.remote.execution.v2.SplitBlobRequest.chunking_function:type_name -> build.bazel.remote.execution.v2.ChunkingFunction.Value
	15,  // 80: build.bazel.remote.execution.v2.SplitBlobResponse.chunk_digests:type_name -> build.bazel.remote.execution.v2.Digest
	3,   // 81: build.bazel.remote.execution.v2.SplitBlobResponse.chunking_function:type_name -> build.bazel.remote.execution.v2.ChunkingFunction.Value
	15,  // 82: build.bazel.remote.execution.v2.SplitBlobResponse.indirect_chunk_list:type_name -> build.bazel.remote.execution.v2.Digest
	...
	15,  // 87: build.bazel.remote.execution.v2.SpliceBlobRequest.indirect_chunk_list:type_name -> build.bazel.remote.execution.v2.Digest
	15,  // 88: build.bazel.remote.execution.v2.SpliceBlobResponse.blob_digest:type_name -> build.bazel.remote.execution.v2.Digest
	53,  // 89: build.bazel.remote.execution.v2.ServerCapabilities.cache_capabilities:type_name -> build.bazel.remote.execution.v2.CacheCapabilities
	56,  // 90: build.bazel.remote.execution.v2.ServerCapabilities.execution_capabilities:type_name -> build.bazel.remote.execution.v2.ExecutionCapabilities
	71,  // 91: build.bazel.remote.execution.v2.ServerCapabilities.deprecated_api_version:type_name -> build.bazel.semver.SemVer
	71,  // 92: build.bazel.remote.execution.v2.ServerCapabilities.low_api_version:type_name -> build.bazel.semver.SemVer
	71,  // 93: build.bazel.remote.execution.v2.ServerCapabilities.high_api_version:type_name -> build.bazel.semver.SemVer
	65,  // 94: build.bazel.remote.execution.v2.PriorityCapabilities.priorities:type_name -> build.bazel.remote.execution.v2.PriorityCapabilities.PriorityRange
	2,   // 95: build.bazel.remote.execution.v2.CacheCapabilities.digest_functions:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	49,  // 96: build.bazel.remote.execution.v2.CacheCapabilities.action_cache_update_capabilities:type_name -> build.bazel.remote.execution.v2.ActionCacheUpdateCapabilities
	50,  // 97: build.bazel.remote.execution.v2.CacheCapabilities.cache_priority_capabilities:type_name -> build.bazel.remote.execution.v2.PriorityCapabilities
	4,   // 98: build.bazel.remote.execution.v2.CacheCapabilities.symlink_absolute_path_strategy:type_name -> build.bazel.remote.execution.v2.SymlinkAbsolutePathStrategy.Value
	5,   // 99: build.bazel.remote.execution.v2.CacheCapabilities.supported_compressors:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	5,   // 100: build.bazel.remote.execution.v2.CacheCapabilities.supported_batch_update_compressors:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	54,  // 101: build.bazel.remote.execution.v2.CacheCapabilities.fast_cdc_2020_params:type_name -> build.bazel.remote.execution.v2.FastCdc2020Params
	55,  // 102: build.bazel.remote.execution.v2.CacheCapabilities.rep_max_cdc_params:type_name -> build.bazel.remote.execution.v2.RepMaxCdcParams
	...
	57,  // 106: build.bazel.remote.execution.v2.RequestMetadata.tool_details:type_name -> build.bazel.remote.execution.v2.ToolDetails
	25,  // 107: build.bazel.remote.execution.v2.ExecuteResponse.ServerLogsEntry.value:type_name -> build.bazel.remote.execution.v2.LogFile
	...
	5,   // 109: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.Request.compressor:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	...
	70,  // 111: build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.Response.status:type_name -> google.rpc.Status
	...
	5,   // 113: build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response.compressor:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	70,  // 114: build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response.status:type_name -> google.rpc.Status
	24,  // 115: build.bazel.remote.execution.v2.Execution.Execute:input_type -> build.bazel.remote.execution.v2.ExecuteRequest
	29,  // 116: build.bazel.remote.execution.v2.Execution.WaitExecution:input_type -> build.bazel.remote.execution.v2.WaitExecutionRequest
	30,  // 117: build.bazel.remote.execution.v2.ActionCache.GetActionResult:input_type -> build.bazel.remote.execution.v2.GetActionResultRequest
	31,  // 118: build.bazel.remote.execution.v2.ActionCache.UpdateActionResult:input_type -> build.bazel.remote.execution.v2.UpdateActionResultRequest
	32,  // 119: build.bazel.remote.execution.v2.ContentAddressableStorage.FindMissingBlobs:input_type -> build.bazel.remote.execution.v2.FindMissingBlobsRequest
	34,  // 120: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchUpdateBlobs:input_type -> build.bazel.remote.execution.v2.BatchUpdateBlobsRequest
	36,  // 121: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs:input_type -> build.bazel.remote.execution.v2.BatchReadBlobsRequest
	38,  // 122: build.bazel.remote.execution.v2.ContentAddressableStorage.GetTree:input_type -> build.bazel.remote.execution.v2.GetTreeRequest
	41,  // 123: build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlob:input_type -> build.bazel.remote.execution.v2.SplitBlobRequest
	43,  // 124: build.bazel.remote.execution.v2.ContentAddressableStorage.SpliceBlob:input_type -> build.bazel.remote.execution.v2.SpliceBlobRequest
	45,  // 125: build.bazel.remote.execution.v2.Capabilities.GetCapabilities:input_type -> build.bazel.remote.execution.v2.GetCapabilitiesRequest
	72,  // 126: build.bazel.remote.execution.v2.Execution.Execute:output_type -> google.longrunning.Operation
	72,  // 127: build.bazel.remote.execution.v2.Execution.WaitExecution:output_type -> google.longrunning.Operation
	17,  // 128: build.bazel.remote.execution.v2.ActionCache.GetActionResult:output_type -> build.bazel.remote.execution.v2.ActionResult
	17,  // 129: build.bazel.remote.execution.v2.ActionCache.UpdateActionResult:output_type -> build.bazel.remote.execution.v2.ActionResult
	33,  // 130: build.bazel.remote.execution.v2.ContentAddressableStorage.FindMissingBlobs:output_type -> build.bazel.remote.execution.v2.FindMissingBlobsResponse
	35,  // 131: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchUpdateBlobs:output_type -> build.bazel.remote.execution.v2.BatchUpdateBlobsResponse
	37,  // 132: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs:output_type -> build.bazel.remote.execution.v2.BatchReadBlobsResponse
	39,  // 133: build.bazel.remote.execution.v2.ContentAddressableStorage.GetTree:output_type -> build.bazel.remote.execution.v2.GetTreeResponse
	42,  // 134: build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlob:output_type -> build.bazel.remote.execution.v2.SplitBlobResponse
	44,  // 135: build.bazel.remote.execution.v2.ContentAddressableStorage.SpliceBlob:output_type -> build.bazel.remote.execution.v2.SpliceBlobResponse
	46,  // 136: build.bazel.remote.execution.v2.Capabilities.GetCapabilities:output_type -> build.bazel.remote.execution.v2.ServerCapabilities
	126, // [126:137] is the sub-list for method output_type
	115, // [115:126] is the sub-list for method input_type
