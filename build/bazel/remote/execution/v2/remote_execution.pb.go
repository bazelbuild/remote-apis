...
func (ExecutionStage_Value) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{22, 0}
}
...
type ActionResult struct {
	...
	//
	// DEPRECATED since v2.2: Use `console_raw` instead. The same
	// information may be obtained by concatenating the `log` field of all
	// [ConsoleMessages][build.bazel.remote.execution.v2.ConsoleMessage]
	// where `stream` equals "stdout".
	StdoutRaw []byte `protobuf:"bytes,5,opt,name=stdout_raw,json=stdoutRaw,proto3" json:"stdout_raw,omitempty"`
	// The digest for a blob containing the standard output of the action, which
	// can be retrieved from the
	// [ContentAddressableStorage][build.bazel.remote.execution.v2.ContentAddressableStorage].
	//
	// DEPRECATED since v2.2: Use `console_digest` instead.
	...
	// The console messages generated by the action, sorted by the time at
	// which they were performed.
	//
	// The server SHOULD NOT inline console messages unless requested by
	// the client in the
	// [GetActionResultRequest][build.bazel.remote.execution.v2.GetActionResultRequest]
	// message. The server MAY omit inlining, even if requested, and MUST
	// do so if inlining would cause the response to exceed message size
	// limits.
	ConsoleRaw []*ConsoleMessage `protobuf:"bytes,13,rep,name=console_raw,json=consoleRaw,proto3" json:"console_raw,omitempty"`
	// The digest for a blob containing the console messages of the
	// action, which can be retrieved from the
	// [ContentAddressableStorage][build.bazel.remote.execution.v2.ContentAddressableStorage].
	//
	// This blob contains a sequence of
	// [ConsoleMessages][build.bazel.remote.execution.v2.ConsoleMessage],
	// sorted by the time at which they were written by the action. Each
	// message is prefixed with its length encoded as a variable length
	// integer. This format can be read using the protocol buffer library's
	...
	// method.
	ConsoleDigest *Digest `protobuf:"bytes,14,opt,name=console_digest,json=consoleDigest,proto3" json:"console_digest,omitempty"`
...
func (m *ActionResult) GetConsoleRaw() []*ConsoleMessage {
	if m != nil {
		return m.ConsoleRaw
	}
	return nil
...
func (m *ActionResult) GetConsoleDigest() *Digest {
	if m != nil {
		return m.ConsoleDigest
	}
	return nil
}
...
// A ConsoleMessage corresponds to one or more writes performed by an
// action against a standard logging facility provided by the operating
// system.
//
// The schema of this message is based on the logging format used by
// Docker: https://docs.docker.com/config/containers/logging/json-file/
type ConsoleMessage struct {
	// The data written to the console by the application. This field must
	// be between 1 and 2^20 bytes in size, inclusive.
	Log []byte `protobuf:"bytes,1,opt,name=log,proto3" json:"log,omitempty"`
	// The name of the standard logging facility to which this message was
	// written. Predefined names are "stdout" and "stderr", corresponding
	// to standard output and standard error respectively. Other values
	// are permitted as well.
	Stream string `protobuf:"bytes,2,opt,name=stream,proto3" json:"stream,omitempty"`
	// An optional time at which the writes took place.
...
func (m *ConsoleMessage) Reset()         { *m = ConsoleMessage{} }
func (m *ConsoleMessage) String() string { return proto.CompactTextString(m) }
func (*ConsoleMessage) ProtoMessage()    {}
func (*ConsoleMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{12}
}

func (m *ConsoleMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ConsoleMessage.Unmarshal(m, b)
}
func (m *ConsoleMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ConsoleMessage.Marshal(b, m, deterministic)
}
func (m *ConsoleMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConsoleMessage.Merge(m, src)
}
func (m *ConsoleMessage) XXX_Size() int {
	return xxx_messageInfo_ConsoleMessage.Size(m)
}
func (m *ConsoleMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_ConsoleMessage.DiscardUnknown(m)
}

var xxx_messageInfo_ConsoleMessage proto.InternalMessageInfo

func (m *ConsoleMessage) GetLog() []byte {
	if m != nil {
		return m.Log
	}
	return nil
...
func (m *ConsoleMessage) GetStream() string {
	if m != nil {
		return m.Stream
	}
	return ""
...
func (m *ConsoleMessage) GetTime() *timestamp.Timestamp {
	if m != nil {
		return m.Time
	}
	return nil
...
type ExecuteOperationMetadata struct {
	...
	//
	// DEPRECATED since v2.2: Use `console_stream_name` instead.
	...
	// If set, the client can use this resource name with
	// [ByteStream.Read][google.bytestream.ByteStream.Read] to stream the
	// console messages from the endpoint hosting streamed responses.
	ConsoleStreamName    string   `protobuf:"bytes,5,opt,name=console_stream_name,json=consoleStreamName,proto3" json:"console_stream_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ExecuteOperationMetadata) GetConsoleStreamName() string {
	if m != nil {
		return m.ConsoleStreamName
	}
	return ""
}
...
type GetActionResultRequest struct {
	...
	//
	// DEPRECATED since v2.2: Use `inline_console` instead.
	...
	// A hint to the server to request inlining console messages in the
	// [ActionResult][build.bazel.remote.execution.v2.ActionResult] message.
	InlineConsole bool `protobuf:"varint,6,opt,name=inline_console,json=inlineConsole,proto3" json:"inline_console,omitempty"`
...
func (m *GetActionResultRequest) GetInlineConsole() bool {
	if m != nil {
		return m.InlineConsole
	}
	return false
}
...
func (*BatchReadBlobsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{32, 0}
}
...
func init() {
	...
	proto.RegisterType((*ConsoleMessage)(nil), "build.bazel.remote.execution.v2.ConsoleMessage")
...
var fileDescriptor_c43847ba40caac95 = []byte{
	...
	,
}
