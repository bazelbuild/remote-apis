...
type ConcatenateBlobsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// omitted.
	InstanceName string `protobuf:"bytes,1,opt,name=instance_name,json=instanceName,proto3" json:"instance_name,omitempty"`
	// The digest function used for constructing the concatenated blobs.
	//
	// This field MUST be set to a value other than UNKNOWN.
	DigestFunction DigestFunction_Value `protobuf:"varint,2,opt,name=digest_function,json=digestFunction,proto3,enum=build.bazel.remote.execution.v2.DigestFunction_Value" json:"digest_function,omitempty"`
	// The individual concatenation requests.
	Requests []*ConcatenateBlobsRequest_Request `protobuf:"bytes,3,rep,name=requests,proto3" json:"requests,omitempty"`
}

func (x *ConcatenateBlobsRequest) Reset() {
	*x = ConcatenateBlobsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConcatenateBlobsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConcatenateBlobsRequest) ProtoMessage() {}

func (x *ConcatenateBlobsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConcatenateBlobsRequest.ProtoReflect.Descriptor instead.
func (*ConcatenateBlobsRequest) Descriptor() ([]byte, []int) {
	return file_build_bazel_remote_execution_v2_remote_execution_proto_rawDescGZIP(), []int{30}
}

func (x *ConcatenateBlobsRequest) GetInstanceName() string {
	if x != nil {
		return x.InstanceName
	}
	return ""
...
func (x *ConcatenateBlobsRequest) GetDigestFunction() DigestFunction_Value {
	if x != nil {
		return x.DigestFunction
	}
	return DigestFunction_UNKNOWN
...
func (x *ConcatenateBlobsRequest) GetRequests() []*ConcatenateBlobsRequest_Request {
	if x != nil {
		return x.Requests
	}
	return nil
...
type SplitBlobsRequest struct {
	...
	// omitted.
	InstanceName string `protobuf:"bytes,1,opt,name=instance_name,json=instanceName,proto3" json:"instance_name,omitempty"`
	// The digest function used for constructing the split blobs.
	//
	// This field MUST be set to a value other than UNKNOWN.
	DigestFunction DigestFunction_Value `protobuf:"varint,2,opt,name=digest_function,json=digestFunction,proto3,enum=build.bazel.remote.execution.v2.DigestFunction_Value" json:"digest_function,omitempty"`
	// The digests of the large blobs to split into smaller blobs.
	LargeDigests []*Digest `protobuf:"bytes,3,rep,name=large_digests,json=largeDigests,proto3" json:"large_digests,omitempty"`
	// The size of the non-trailing blobs to create. It must be less than
	// the sizes stored in `digests`.
	SplitSizeBytes int64 `protobuf:"varint,4,opt,name=split_size_bytes,json=splitSizeBytes,proto3" json:"split_size_bytes,omitempty"`
}

func (x *SplitBlobsRequest) Reset() {
	*x = SplitBlobsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SplitBlobsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SplitBlobsRequest) ProtoMessage() {}

func (x *SplitBlobsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SplitBlobsRequest.ProtoReflect.Descriptor instead.
func (*SplitBlobsRequest) Descriptor() ([]byte, []int) {
	return file_build_bazel_remote_execution_v2_remote_execution_proto_rawDescGZIP(), []int{31}
}

func (x *SplitBlobsRequest) GetInstanceName() string {
	if x != nil {
		return x.InstanceName
	}
	return ""
...
func (x *SplitBlobsRequest) GetDigestFunction() DigestFunction_Value {
	if x != nil {
		return x.DigestFunction
	}
	return DigestFunction_UNKNOWN
...
func (x *SplitBlobsRequest) GetLargeDigests() []*Digest {
	if x != nil {
		return x.LargeDigests
	}
	return nil
}

func (x *SplitBlobsRequest) GetSplitSizeBytes() int64 {
	if x != nil {
		return x.SplitSizeBytes
	}
	return 0
}

type SplitBlobsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The responses to the requests.
	Responses []*SplitBlobsResponse_Response `protobuf:"bytes,1,rep,name=responses,proto3" json:"responses,omitempty"`
}

func (x *SplitBlobsResponse) Reset() {
	*x = SplitBlobsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SplitBlobsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SplitBlobsResponse) ProtoMessage() {}

func (x *SplitBlobsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SplitBlobsResponse.ProtoReflect.Descriptor instead.
func (*SplitBlobsResponse) Descriptor() ([]byte, []int) {
	return file_build_bazel_remote_execution_v2_remote_execution_proto_rawDescGZIP(), []int{32}
}

func (x *SplitBlobsResponse) GetResponses() []*SplitBlobsResponse_Response {
	if x != nil {
		return x.Responses
	}
	return nil
...
type ConcatenateSplitCapabilities struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The digest function to which the capabilities apply.
	//
	// Servers SHOULD only announce these capabilities for digest function
	// SHA256TREE, as none of the other digest functions permit clients to
	// validate the integrity of hashes returned by
	// [SplitBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlobs].
	//
	// Similarly, clients SHOULD also ignore capabilities for digest
	// functions other than SHA256TREE.
	...
	// The minimum size of blobs that can be provided to
	// [ConcatenateBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.ConcatenateBlobs].
	//
	// For SHA256TREE, this field MUST have value 2^k, where k >= 10. It
	// may not exceed `max_batch_total_size_bytes`, thereby ensuring
	// that clients can upload inputs of ConcatenateBlobs using
	// [BatchUpdateBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.BatchUpdateBlobs].
	MinConcatenateSizeBytes int32 `protobuf:"varint,2,opt,name=min_concatenate_size_bytes,json=minConcatenateSizeBytes,proto3" json:"min_concatenate_size_bytes,omitempty"`
	// The minimum size of blobs that can be created by calling
	// [SplitBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlobs].
	//
	// For SHA256TREE, this field MUST have value 2^k, where k >= 10. It
	// may not exceed `max_batch_total_size_bytes`, thereby ensuring
	// that clients can download outputs of SplitBlobs using
	// [BatchReadBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs].
	MinSplitSizeBytes int32 `protobuf:"varint,3,opt,name=min_split_size_bytes,json=minSplitSizeBytes,proto3" json:"min_split_size_bytes,omitempty"`
	// The maximum combined number of entries in `small_hashes` fields
	// that may be provided to
	// [ConcatenateBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.ConcatenateBlobs]
	// and returned by
	// [SplitBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlobs].
	//
	// If blobs need to be processed whose number of smaller blobs exceed
	// this limit, these methods need to be called recursively.
	MaxSmallHashes int32 `protobuf:"varint,4,opt,name=max_small_hashes,json=maxSmallHashes,proto3" json:"max_small_hashes,omitempty"`
}

func (x *ConcatenateSplitCapabilities) Reset() {
	*x = ConcatenateSplitCapabilities{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConcatenateSplitCapabilities) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConcatenateSplitCapabilities) ProtoMessage() {}

func (x *ConcatenateSplitCapabilities) ProtoReflect() protoreflect.Message {
	mi := &file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[44]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConcatenateSplitCapabilities.ProtoReflect.Descriptor instead.
func (*ConcatenateSplitCapabilities) Descriptor() ([]byte, []int) {
	return file_build_bazel_remote_execution_v2_remote_execution_proto_rawDescGZIP(), []int{44}
}

func (x *ConcatenateSplitCapabilities) GetDigestFunction() DigestFunction_Value {
	if x != nil {
		return x.DigestFunction
	}
	return DigestFunction_UNKNOWN
...
func (x *ConcatenateSplitCapabilities) GetMinConcatenateSizeBytes() int32 {
	if x != nil {
		return x.MinConcatenateSizeBytes
	}
	return 0
}

func (x *ConcatenateSplitCapabilities) GetMinSplitSizeBytes() int32 {
	if x != nil {
		return x.MinSplitSizeBytes
	}
	return 0
}

func (x *ConcatenateSplitCapabilities) GetMaxSmallHashes() int32 {
	if x != nil {
		return x.MaxSmallHashes
	}
	return 0
}
...
type CacheCapabilities struct {
	...
	// Capabilities pertaining to the
	// [ConcatenateBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.ConcatenateBlobs]
	// and [SplitBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlobs]
	// requests.
	ConcatenateSplitCapabilities []*ConcatenateSplitCapabilities `protobuf:"bytes,8,rep,name=concatenate_split_capabilities,json=concatenateSplitCapabilities,proto3" json:"concatenate_split_capabilities,omitempty"`
}
...
func (x *CacheCapabilities) GetConcatenateSplitCapabilities() []*ConcatenateSplitCapabilities {
	if x != nil {
		return x.ConcatenateSplitCapabilities
	}
	return nil
}
...
type ConcatenateBlobsRequest_Request struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The digest of the blob to create.
	LargeDigest *Digest `protobuf:"bytes,1,opt,name=large_digest,json=largeDigest,proto3" json:"large_digest,omitempty"`
	// The hashes of the smaller blobs to concatenate.
	//
	// All elements except for the final correspond to the hashes of
	// blobs having size 2^k. The final element corresponds to the hash
	// of a blob containing l bytes of trailing data, where
	// 0 < l <= 2^k. The server may infer the values of k and l using
	// `large_digest.size_bytes` and the length of this field.
	SmallHashes []string `protobuf:"bytes,2,rep,name=small_hashes,json=smallHashes,proto3" json:"small_hashes,omitempty"`
}

func (x *ConcatenateBlobsRequest_Request) Reset() {
	*x = ConcatenateBlobsRequest_Request{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConcatenateBlobsRequest_Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConcatenateBlobsRequest_Request) ProtoMessage() {}

func (x *ConcatenateBlobsRequest_Request) ProtoReflect() protoreflect.Message {
	mi := &file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[54]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConcatenateBlobsRequest_Request.ProtoReflect.Descriptor instead.
func (*ConcatenateBlobsRequest_Request) Descriptor() ([]byte, []int) {
	return file_build_bazel_remote_execution_v2_remote_execution_proto_rawDescGZIP(), []int{30, 0}
}

func (x *ConcatenateBlobsRequest_Request) GetLargeDigest() *Digest {
	if x != nil {
		return x.LargeDigest
	}
	return nil
}

func (x *ConcatenateBlobsRequest_Request) GetSmallHashes() []string {
	if x != nil {
		return x.SmallHashes
	}
	return nil
}

type SplitBlobsResponse_Response struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The result of attempting to split that blob.
	Status *status.Status `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	// The hashes of the smaller blobs that were created.
	//
	// All elements except the final correspond to the blobs having size
	// `split_size_bytes`. The final element corresponds to the the
	// non-empty blob containing trailing data, having size
	// `digest.size_bytes % split_size_bytes`.
	SmallHashes []string `protobuf:"bytes,2,rep,name=small_hashes,json=smallHashes,proto3" json:"small_hashes,omitempty"`
}

func (x *SplitBlobsResponse_Response) Reset() {
	*x = SplitBlobsResponse_Response{}
	if protoimpl.UnsafeEnabled {
...
func (x *SplitBlobsResponse_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SplitBlobsResponse_Response) ProtoMessage() {}

func (x *SplitBlobsResponse_Response) ProtoReflect() protoreflect.Message {
	mi := &file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SplitBlobsResponse_Response.ProtoReflect.Descriptor instead.
func (*SplitBlobsResponse_Response) Descriptor() ([]byte, []int) {
	return file_build_bazel_remote_execution_v2_remote_execution_proto_rawDescGZIP(), []int{32, 0}
}

func (x *SplitBlobsResponse_Response) GetStatus() *status.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *SplitBlobsResponse_Response) GetSmallHashes() []string {
	if x != nil {
		return x.SmallHashes
	}
	return nil
...
func (*BatchReadBlobsResponse_Response) Descriptor() ([]byte, []int) {
	return file_build_bazel_remote_execution_v2_remote_execution_proto_rawDescGZIP(), []int{34, 0}
}
...
var file_build_bazel_remote_execution_v2_remote_execution_proto_rawDesc = []byte{
	...
	0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x5e, 0x0a, 0x0f, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x5f,
	0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x35,
	0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72, 0x65, 0x6d,
	0x6f, 0x74, 0x65, 0x2e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x32,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa9, 0x03, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x43, 0x61, 0x63, 0x68, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x12, 0x5e, 0x0a, 0x0f, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x5f, 0x66, 0x75, 0x6e, 0x63,
	...
	0x6e, 0x22, 0xea, 0x01, 0x0a, 0x17, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x69, 0x73, 0x73, 0x69, 0x6e,
	...
	0x2e, 0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x44, 0x69, 0x67, 0x65, 0x73,
	0x74, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x62, 0x44, 0x69, 0x67, 0x65, 0x73, 0x74, 0x73, 0x12, 0x5e,
	0x0a, 0x0f, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x5f, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x35, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e,
	0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65, 0x78, 0x65,
	...
	0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x75,
	...
	0x67, 0x65, 0x73, 0x74, 0x73, 0x22, 0xb0, 0x03, 0x0a, 0x17, 0x42, 0x61, 0x74, 0x63, 0x68, 0x55,
	...
	0x65, 0x73, 0x74, 0x73, 0x12, 0x5e, 0x0a, 0x0f, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x5f, 0x66,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x1a, 0xb1, 0x01, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x3f, 0x0a, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x27, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72,
	0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
	0x76, 0x32, 0x2e, 0x44, 0x69, 0x67, 0x65, 0x73, 0x74, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73,
	...
	0x22, 0xf6, 0x02, 0x0a, 0x17, 0x43, 0x6f, 0x6e, 0x63, 0x61, 0x74, 0x65, 0x6e, 0x61, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x1a, 0xde, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f,
	...
	0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x31, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e,
	0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65, 0x78, 0x65,
	...
	0x72, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x12, 0x2a, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x75, 0x73, 0x22, 0x9b, 0x02, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x65, 0x65, 0x52, 0x65,
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x48, 0x0a, 0x0b, 0x72, 0x6f,
	0x6f, 0x74, 0x5f, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x27, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72, 0x65,
	0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76,
	0x32, 0x2e, 0x44, 0x69, 0x67, 0x65, 0x73, 0x74, 0x52, 0x0a, 0x72, 0x6f, 0x6f, 0x74, 0x44, 0x69,
	0x67, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x35, 0x2e, 0x62, 0x75, 0x69, 0x6c,
	0x64, 0x2e, 0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65,
	0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x44, 0x69, 0x67, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x64, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x22, 0x4d, 0x0a,
	0x0b, 0x54, 0x6f, 0x6f, 0x6c, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x1b, 0x0a, 0x09,
	...
	,
	...
	0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x32, 0xb9, 0x02, 0x0a, 0x09, 0x45, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x8e, 0x01, 0x0a, 0x07, 0x45, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x65, 0x12, 0x2f, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x61, 0x7a, 0x65,
	0x6c, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71,
	...
	,
	...
	0x3a, 0x01, 0x2a, 0x30, 0x01, 0x32, 0xd6, 0x03, 0x0a, 0x0b, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0xd7, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x41, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x37, 0x2e, 0x62, 0x75, 0x69, 0x6c,
	0x64, 0x2e, 0x62, 0x61, 0x7a, 0x65, 0x6c, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x65,
	0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x47, 0x65, 0x74, 0x41,
	...
	,
	...
	0x64, 0x4d, 0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x3a, 0x01, 0x2a, 0x12, 0xbc, 0x01, 0x0a, 0x10,
	...
	,
	...
	,
	...
	0x2f, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x42, 0xb4, 0x01,
	...
	0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x76, 0x32, 0x3b, 0x72, 0x65, 0x6d,
	0x6f, 0x74, 0x65, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0xa2, 0x02, 0x03, 0x52,
...
var file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 58)
var file_build_bazel_remote_execution_v2_remote_execution_proto_goTypes = []interface{}{
	...
	(*ConcatenateBlobsRequest)(nil),            // 34: build.bazel.remote.execution.v2.ConcatenateBlobsRequest
	(*SplitBlobsRequest)(nil),                  // 35: build.bazel.remote.execution.v2.SplitBlobsRequest
	(*SplitBlobsResponse)(nil),                 // 36: build.bazel.remote.execution.v2.SplitBlobsResponse
	...
	(*GetTreeResponse)(nil),                    // 40: build.bazel.remote.execution.v2.GetTreeResponse
	(*GetCapabilitiesRequest)(nil),             // 41: build.bazel.remote.execution.v2.GetCapabilitiesRequest
	(*ServerCapabilities)(nil),                 // 42: build.bazel.remote.execution.v2.ServerCapabilities
	(*DigestFunction)(nil),                     // 43: build.bazel.remote.execution.v2.DigestFunction
	(*ActionCacheUpdateCapabilities)(nil),      // 44: build.bazel.remote.execution.v2.ActionCacheUpdateCapabilities
	(*PriorityCapabilities)(nil),               // 45: build.bazel.remote.execution.v2.PriorityCapabilities
	(*SymlinkAbsolutePathStrategy)(nil),        // 46: build.bazel.remote.execution.v2.SymlinkAbsolutePathStrategy
	(*Compressor)(nil),                         // 47: build.bazel.remote.execution.v2.Compressor
	(*ConcatenateSplitCapabilities)(nil),       // 48: build.bazel.remote.execution.v2.ConcatenateSplitCapabilities
	(*CacheCapabilities)(nil),                  // 49: build.bazel.remote.execution.v2.CacheCapabilities
	(*ExecutionCapabilities)(nil),              // 50: build.bazel.remote.execution.v2.ExecutionCapabilities
	(*ToolDetails)(nil),                        // 51: build.bazel.remote.execution.v2.ToolDetails
	(*RequestMetadata)(nil),                    // 52: build.bazel.remote.execution.v2.RequestMetadata
	(*Command_EnvironmentVariable)(nil),        // 53: build.bazel.remote.execution.v2.Command.EnvironmentVariable
	(*Platform_Property)(nil),                  // 54: build.bazel.remote.execution.v2.Platform.Property
	nil,                                        // 55: build.bazel.remote.execution.v2.ExecuteResponse.ServerLogsEntry
	(*BatchUpdateBlobsRequest_Request)(nil),    // 56: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.Request
	(*BatchUpdateBlobsResponse_Response)(nil),  // 57: build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.Response
	(*ConcatenateBlobsRequest_Request)(nil),    // 58: build.bazel.remote.execution.v2.ConcatenateBlobsRequest.Request
	(*SplitBlobsResponse_Response)(nil),        // 59: build.bazel.remote.execution.v2.SplitBlobsResponse.Response
	(*BatchReadBlobsResponse_Response)(nil),    // 60: build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response
	(*PriorityCapabilities_PriorityRange)(nil), // 61: build.bazel.remote.execution.v2.PriorityCapabilities.PriorityRange
	...
	(*semver.SemVer)(nil),                      // 67: build.bazel.semver.SemVer
...
var file_build_bazel_remote_execution_v2_remote_execution_proto_depIdxs = []int32{
	...
	62,  // 2: build.bazel.remote.execution.v2.Action.timeout:type_name -> google.protobuf.Duration
	6,   // 3: build.bazel.remote.execution.v2.Action.platform:type_name -> build.bazel.remote.execution.v2.Platform
	53,  // 4: build.bazel.remote.execution.v2.Command.environment_variables:type_name -> build.bazel.remote.execution.v2.Command.EnvironmentVariable
	6,   // 5: build.bazel.remote.execution.v2.Command.platform:type_name -> build.bazel.remote.execution.v2.Platform
	54,  // 6: build.bazel.remote.execution.v2.Platform.properties:type_name -> build.bazel.remote.execution.v2.Platform.Property
	...
	63,  // 12: build.bazel.remote.execution.v2.NodeProperties.mtime:type_name -> google.protobuf.Timestamp
	64,  // 13: build.bazel.remote.execution.v2.NodeProperties.unix_mode:type_name -> google.protobuf.UInt32Value
	...
	63,  // 18: build.bazel.remote.execution.v2.ExecutedActionMetadata.queued_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 19: build.bazel.remote.execution.v2.ExecutedActionMetadata.worker_start_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 20: build.bazel.remote.execution.v2.ExecutedActionMetadata.worker_completed_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 21: build.bazel.remote.execution.v2.ExecutedActionMetadata.input_fetch_start_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 22: build.bazel.remote.execution.v2.ExecutedActionMetadata.input_fetch_completed_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 23: build.bazel.remote.execution.v2.ExecutedActionMetadata.execution_start_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 24: build.bazel.remote.execution.v2.ExecutedActionMetadata.execution_completed_timestamp:type_name -> google.protobuf.Timestamp
	62,  // 25: build.bazel.remote.execution.v2.ExecutedActionMetadata.virtual_execution_duration:type_name -> google.protobuf.Duration
	63,  // 26: build.bazel.remote.execution.v2.ExecutedActionMetadata.output_upload_start_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 27: build.bazel.remote.execution.v2.ExecutedActionMetadata.output_upload_completed_timestamp:type_name -> google.protobuf.Timestamp
	65,  // 28: build.bazel.remote.execution.v2.ExecutedActionMetadata.auxiliary_metadata:type_name -> google.protobuf.Any
	...
	66,  // 49: build.bazel.remote.execution.v2.ExecuteResponse.status:type_name -> google.rpc.Status
	55,  // 50: build.bazel.remote.execution.v2.ExecuteResponse.server_logs:type_name -> build.bazel.remote.execution.v2.ExecuteResponse.ServerLogsEntry
	...
	13,  // 53: build.bazel.remote.execution.v2.GetActionResultRequest.action_digest:type_name -> build.bazel.remote.execution.v2.Digest
	1,   // 54: build.bazel.remote.execution.v2.GetActionResultRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	13,  // 55: build.bazel.remote.execution.v2.UpdateActionResultRequest.action_digest:type_name -> build.bazel.remote.execution.v2.Digest
	15,  // 56: build.bazel.remote.execution.v2.UpdateActionResultRequest.action_result:type_name -> build.bazel.remote.execution.v2.ActionResult
	21,  // 57: build.bazel.remote.execution.v2.UpdateActionResultRequest.results_cache_policy:type_name -> build.bazel.remote.execution.v2.ResultsCachePolicy
	1,   // 58: build.bazel.remote.execution.v2.UpdateActionResultRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	13,  // 59: build.bazel.remote.execution.v2.FindMissingBlobsRequest.blob_digests:type_name -> build.bazel.remote.execution.v2.Digest
	1,   // 60: build.bazel.remote.execution.v2.FindMissingBlobsRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	13,  // 61: build.bazel.remote.execution.v2.FindMissingBlobsResponse.missing_blob_digests:type_name -> build.bazel.remote.execution.v2.Digest
	56,  // 62: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.requests:type_name -> build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.Request
	1,   // 63: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	57,  // 64: build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.responses:type_name -> build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.Response
	1,   // 65: build.bazel.remote.execution.v2.ConcatenateBlobsRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	58,  // 66: build.bazel.remote.execution.v2.ConcatenateBlobsRequest.requests:type_name -> build.bazel.remote.execution.v2.ConcatenateBlobsRequest.Request
	1,   // 67: build.bazel.remote.execution.v2.SplitBlobsRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	13,  // 68: build.bazel.remote.execution.v2.SplitBlobsRequest.large_digests:type_name -> build.bazel.remote.execution.v2.Digest
	59,  // 69: build.bazel.remote.execution.v2.SplitBlobsResponse.responses:type_name -> build.bazel.remote.execution.v2.SplitBlobsResponse.Response
	13,  // 70: build.bazel.remote.execution.v2.BatchReadBlobsRequest.digests:type_name -> build.bazel.remote.execution.v2.Digest
	3,   // 71: build.bazel.remote.execution.v2.BatchReadBlobsRequest.acceptable_compressors:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	1,   // 72: build.bazel.remote.execution.v2.BatchReadBlobsRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	60,  // 73: build.bazel.remote.execution.v2.BatchReadBlobsResponse.responses:type_name -> build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response
	13,  // 74: build.bazel.remote.execution.v2.GetTreeRequest.root_digest:type_name -> build.bazel.remote.execution.v2.Digest
	1,   // 75: build.bazel.remote.execution.v2.GetTreeRequest.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	7,   // 76: build.bazel.remote.execution.v2.GetTreeResponse.directories:type_name -> build.bazel.remote.execution.v2.Directory
	49,  // 77: build.bazel.remote.execution.v2.ServerCapabilities.cache_capabilities:type_name -> build.bazel.remote.execution.v2.CacheCapabilities
	50,  // 78: build.bazel.remote.execution.v2.ServerCapabilities.execution_capabilities:type_name -> build.bazel.remote.execution.v2.ExecutionCapabilities
	67,  // 79: build.bazel.remote.execution.v2.ServerCapabilities.deprecated_api_version:type_name -> build.bazel.semver.SemVer
	67,  // 80: build.bazel.remote.execution.v2.ServerCapabilities.low_api_version:type_name -> build.bazel.semver.SemVer
	67,  // 81: build.bazel.remote.execution.v2.ServerCapabilities.high_api_version:type_name -> build.bazel.semver.SemVer
	61,  // 82: build.bazel.remote.execution.v2.PriorityCapabilities.priorities:type_name -> build.bazel.remote.execution.v2.PriorityCapabilities.PriorityRange
	1,   // 83: build.bazel.remote.execution.v2.ConcatenateSplitCapabilities.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	1,   // 84: build.bazel.remote.execution.v2.CacheCapabilities.digest_functions:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	44,  // 85: build.bazel.remote.execution.v2.CacheCapabilities.action_cache_update_capabilities:type_name -> build.bazel.remote.execution.v2.ActionCacheUpdateCapabilities
	45,  // 86: build.bazel.remote.execution.v2.CacheCapabilities.cache_priority_capabilities:type_name -> build.bazel.remote.execution.v2.PriorityCapabilities
	2,   // 87: build.bazel.remote.execution.v2.CacheCapabilities.symlink_absolute_path_strategy:type_name -> build.bazel.remote.execution.v2.SymlinkAbsolutePathStrategy.Value
	3,   // 88: build.bazel.remote.execution.v2.CacheCapabilities.supported_compressors:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	3,   // 89: build.bazel.remote.execution.v2.CacheCapabilities.supported_batch_update_compressors:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	48,  // 90: build.bazel.remote.execution.v2.CacheCapabilities.concatenate_split_capabilities:type_name -> build.bazel.remote.execution.v2.ConcatenateSplitCapabilities
	1,   // 91: build.bazel.remote.execution.v2.ExecutionCapabilities.digest_function:type_name -> build.bazel.remote.execution.v2.DigestFunction.Value
	45,  // 92: build.bazel.remote.execution.v2.ExecutionCapabilities.execution_priority_capabilities:type_name -> build.bazel.remote.execution.v2.PriorityCapabilities
	51,  // 93: build.bazel.remote.execution.v2.RequestMetadata.tool_details:type_name -> build.bazel.remote.execution.v2.ToolDetails
	23,  // 94: build.bazel.remote.execution.v2.ExecuteResponse.ServerLogsEntry.value:type_name -> build.bazel.remote.execution.v2.LogFile
	13,  // 95: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.Request.digest:type_name -> build.bazel.remote.execution.v2.Digest
	3,   // 96: build.bazel.remote.execution.v2.BatchUpdateBlobsRequest.Request.compressor:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	13,  // 97: build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.Response.digest:type_name -> build.bazel.remote.execution.v2.Digest
	66,  // 98: build.bazel.remote.execution.v2.BatchUpdateBlobsResponse.Response.status:type_name -> google.rpc.Status
	13,  // 99: build.bazel.remote.execution.v2.ConcatenateBlobsRequest.Request.large_digest:type_name -> build.bazel.remote.execution.v2.Digest
	66,  // 100: build.bazel.remote.execution.v2.SplitBlobsResponse.Response.status:type_name -> google.rpc.Status
	13,  // 101: build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response.digest:type_name -> build.bazel.remote.execution.v2.Digest
	3,   // 102: build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response.compressor:type_name -> build.bazel.remote.execution.v2.Compressor.Value
	66,  // 103: build.bazel.remote.execution.v2.BatchReadBlobsResponse.Response.status:type_name -> google.rpc.Status
	22,  // 104: build.bazel.remote.execution.v2.Execution.Execute:input_type -> build.bazel.remote.execution.v2.ExecuteRequest
	27,  // 105: build.bazel.remote.execution.v2.Execution.WaitExecution:input_type -> build.bazel.remote.execution.v2.WaitExecutionRequest
	28,  // 106: build.bazel.remote.execution.v2.ActionCache.GetActionResult:input_type -> build.bazel.remote.execution.v2.GetActionResultRequest
	29,  // 107: build.bazel.remote.execution.v2.ActionCache.UpdateActionResult:input_type -> build.bazel.remote.execution.v2.UpdateActionResultRequest
	30,  // 108: build.bazel.remote.execution.v2.ContentAddressableStorage.FindMissingBlobs:input_type -> build.bazel.remote.execution.v2.FindMissingBlobsRequest
	32,  // 109: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchUpdateBlobs:input_type -> build.bazel.remote.execution.v2.BatchUpdateBlobsRequest
	37,  // 110: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs:input_type -> build.bazel.remote.execution.v2.BatchReadBlobsRequest
	34,  // 111: build.bazel.remote.execution.v2.ContentAddressableStorage.ConcatenateBlobs:input_type -> build.bazel.remote.execution.v2.ConcatenateBlobsRequest
	35,  // 112: build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlobs:input_type -> build.bazel.remote.execution.v2.SplitBlobsRequest
	39,  // 113: build.bazel.remote.execution.v2.ContentAddressableStorage.GetTree:input_type -> build.bazel.remote.execution.v2.GetTreeRequest
	41,  // 114: build.bazel.remote.execution.v2.Capabilities.GetCapabilities:input_type -> build.bazel.remote.execution.v2.GetCapabilitiesRequest
	68,  // 115: build.bazel.remote.execution.v2.Execution.Execute:output_type -> google.longrunning.Operation
	68,  // 116: build.bazel.remote.execution.v2.Execution.WaitExecution:output_type -> google.longrunning.Operation
	15,  // 117: build.bazel.remote.execution.v2.ActionCache.GetActionResult:output_type -> build.bazel.remote.execution.v2.ActionResult
	15,  // 118: build.bazel.remote.execution.v2.ActionCache.UpdateActionResult:output_type -> build.bazel.remote.execution.v2.ActionResult
	31,  // 119: build.bazel.remote.execution.v2.ContentAddressableStorage.FindMissingBlobs:output_type -> build.bazel.remote.execution.v2.FindMissingBlobsResponse
	33,  // 120: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchUpdateBlobs:output_type -> build.bazel.remote.execution.v2.BatchUpdateBlobsResponse
	38,  // 121: build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs:output_type -> build.bazel.remote.execution.v2.BatchReadBlobsResponse
	33,  // 122: build.bazel.remote.execution.v2.ContentAddressableStorage.ConcatenateBlobs:output_type -> build.bazel.remote.execution.v2.BatchUpdateBlobsResponse
	36,  // 123: build.bazel.remote.execution.v2.ContentAddressableStorage.SplitBlobs:output_type -> build.bazel.remote.execution.v2.SplitBlobsResponse
	40,  // 124: build.bazel.remote.execution.v2.ContentAddressableStorage.GetTree:output_type -> build.bazel.remote.execution.v2.GetTreeResponse
	42,  // 125: build.bazel.remote.execution.v2.Capabilities.GetCapabilities:output_type -> build.bazel.remote.execution.v2.ServerCapabilities
...
func file_build_bazel_remote_execution_v2_remote_execution_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConcatenateBlobsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SplitBlobsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SplitBlobsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConcatenateSplitCapabilities); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConcatenateBlobsRequest_Request); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SplitBlobsResponse_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[56].Exporter = func(v interface{}, i int) interface{} {
		...
		file_build_bazel_remote_execution_v2_remote_execution_proto_msgTypes[57].Exporter = func(v interface{}, i int) interface{} {
...
type ContentAddressableStorageClient interface {
	...
	// applicable. If the server announces support for splitting blobs through
	// [CacheCapabilities.concatenate_split_capabilities][build.bazel.remote.execution.v2.CacheCapabilities.concatenate_split_capabilities],
	// the lifetimes of any split blobs previously derived from the referenced
	// blobs SHOULD also be increased.
	//
	...
	// Create blobs by concatenating multiple smaller blobs.
	//
	// This method is only supported for digest functions reported through
	// [CacheCapabilities.concatenate_split_capabilities][build.bazel.remote.execution.v2.CacheCapabilities.concatenate_split_capabilities].
	// For other digest functions new blobs can only be created by uploading them
	// in their entirety.
	//
	// This method may be called recursively to construct very large objects.
	ConcatenateBlobs(ctx context.Context, in *ConcatenateBlobsRequest, opts ...grpc.CallOption) (*BatchUpdateBlobsResponse, error)
	// Create multiple blobs by splitting larger blobs, so that they can
	// subsequently be downloaded by issuing multiple
	// [BatchReadBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs]
	// calls.
	//
	// This method is only supported for digest functions reported through
	...
	// in their entirety.
	//
	// This method may be called recursively to split very large objects.
	SplitBlobs(ctx context.Context, in *SplitBlobsRequest, opts ...grpc.CallOption) (*SplitBlobsResponse, error)
...
func (c *contentAddressableStorageClient) ConcatenateBlobs(ctx context.Context, in *ConcatenateBlobsRequest, opts ...grpc.CallOption) (*BatchUpdateBlobsResponse, error) {
	out := new(BatchUpdateBlobsResponse)
	err := c.cc.Invoke(ctx, "/build.bazel.remote.execution.v2.ContentAddressableStorage/ConcatenateBlobs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentAddressableStorageClient) SplitBlobs(ctx context.Context, in *SplitBlobsRequest, opts ...grpc.CallOption) (*SplitBlobsResponse, error) {
	out := new(SplitBlobsResponse)
	err := c.cc.Invoke(ctx, "/build.bazel.remote.execution.v2.ContentAddressableStorage/SplitBlobs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ContentAddressableStorageServer interface {
	...
	//
	// This method may be called recursively to construct very large objects.
	ConcatenateBlobs(context.Context, *ConcatenateBlobsRequest) (*BatchUpdateBlobsResponse, error)
	// Create multiple blobs by splitting larger blobs, so that they can
	// subsequently be downloaded by issuing multiple
	// [BatchReadBlobs][build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs]
	// calls.
	...
	//
	// This method may be called recursively to split very large objects.
	SplitBlobs(context.Context, *SplitBlobsRequest) (*SplitBlobsResponse, error)
	// Fetch the entire directory tree rooted at a node.
	//
	// This request must be targeted at a
	// [Directory][build.bazel.remote.execution.v2.Directory] stored in the
...
func (*UnimplementedContentAddressableStorageServer) ConcatenateBlobs(context.Context, *ConcatenateBlobsRequest) (*BatchUpdateBlobsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method ConcatenateBlobs not implemented")
}
func (*UnimplementedContentAddressableStorageServer) SplitBlobs(context.Context, *SplitBlobsRequest) (*SplitBlobsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method SplitBlobs not implemented")
}
...
func _ContentAddressableStorage_ConcatenateBlobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConcatenateBlobsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContentAddressableStorageServer).ConcatenateBlobs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/build.bazel.remote.execution.v2.ContentAddressableStorage/ConcatenateBlobs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContentAddressableStorageServer).ConcatenateBlobs(ctx, req.(*ConcatenateBlobsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ContentAddressableStorage_SplitBlobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SplitBlobsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContentAddressableStorageServer).SplitBlobs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/build.bazel.remote.execution.v2.ContentAddressableStorage/SplitBlobs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContentAddressableStorageServer).SplitBlobs(ctx, req.(*SplitBlobsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ContentAddressableStorage_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ConcatenateBlobs",
			Handler:    _ContentAddressableStorage_ConcatenateBlobs_Handler,
		},
		{
			MethodName: "SplitBlobs",
			Handler:    _ContentAddressableStorage_SplitBlobs_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
